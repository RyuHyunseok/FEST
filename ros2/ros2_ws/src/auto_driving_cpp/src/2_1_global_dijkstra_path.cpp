 ...
 * 
 * 6. 주요 함수:
 *    - plan_path(): 다익스트라 알고리즘으로 경로 계획
 *    - get_cost_penalty(): 비용 맵 기반 이동 비용 계산
 *    - reconstruct_path(): 계획된 경로 재구성
 *    - publish_path(): 계획된 경로 발행
 */
