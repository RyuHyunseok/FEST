 ...
 * 
 * 6. 주요 함수:
 *    - plan_path(): 경로 계획 메인 함수
 *    - plan_path_dijkstra(): 다익스트라 알고리즘 구현
 *    - check_obstacles_on_path(): 경로상 장애물 확인
 *    - find_closest_point(): 가장 가까운 경로점 찾기
 */
