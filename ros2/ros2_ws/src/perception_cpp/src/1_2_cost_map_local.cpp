...
public:
    LocalCostMapNode() : Node("local_cost_map"),
                            ...
                            inflation_radius_(1.0), // 30cm 장애물 팽창 반경
                            cost_scaling_factor_(1.0) // 장애물로부터의 거리에 따른 비용 감소 계수
    {
        ...
        lidar_sub_ = create_subscription<sensor_msgs::msg::LaserScan>(
            "/laser_filtered", 10, 
            std::bind(&LocalCostMapNode::lidar_callback, this, std::placeholders::_1));

        odom_sub_ = create_subscription<nav_msgs::msg::Odometry>(
            "/odom", 10, 
            std::bind(&LocalCostMapNode::odom_callback, this, std::placeholders::_1));

        // Timer for periodic updates
        update_timer_ = create_wall_timer(
            100ms, std::bind(&LocalCostMapNode::update_cost_map, this));
    }
